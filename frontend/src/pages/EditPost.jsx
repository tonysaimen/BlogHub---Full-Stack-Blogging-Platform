...
import { FileEdit, Eye, Edit3, Image, Tag, FolderOpen, AlertCircle, ArrowLeft } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        ...
        console.error(err);
        setError('Failed to fetch the article details.');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-100 tracking-tight">Edit Blog Post</h1>
          <p className="text-slate-400 text-xs">Update your post titles, images, categories, or content details.</p>
        </div>
      </div>
              ...
              <div className="border-t border-slate-800/80 pt-6">
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: formData.content || '<p class="text-slate-550 italic">No content written yet.</p>',
                  }}
                ></div>
              </div>
            </div>
